...
import {
  ...
  deleteItem,
  setRefetch,
} from '../../stores/devices/devicesSlice';
import { useAppDispatch, useAppSelector } from '../../stores/hooks';
import { useRouter } from 'next/router';
import { Field, Form, Formik } from 'formik';
import { DataGrid, GridColDef } from '@mui/x-data-grid';
import { loadColumns } from './configureDevicesCols';
...
const TableSampleDevices = ({ filterItems, setFilterItems, filters }) => {
  ...
  useEffect(() => {
    if (devicesNotify.showNotification) {
      notify(devicesNotify.typeNotification, devicesNotify.textNotification);
    }
  }, [devicesNotify.showNotification]);
  ...
  const handleViewAction = (id: string) => {
    router.push(`/devices/devices-view/?id=${id}`);
  };
...
export default TableSampleDevices;
