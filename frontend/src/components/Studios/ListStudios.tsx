...
const ListStudios = ({
  ...
  const hasUpdatePermission = hasPermission(currentUser, 'UPDATE_STUDIOS');
            ...
            <CardBox hasTable key={item.id} className={'rounded'}>
              <div className={'flex items-center overflow-hidden'}>
                ...
                >
                  ...
                  <div className={'flex-1 px-3'}>
                    <p className={'text-xs text-gray-500'}>External website</p>
                    <p className={'line-clamp-2'}>{item.externalwebsite}</p>
                  </div>
                </div>
                <ListActionsPopover
                  onDelete={onDelete}
